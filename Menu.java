 ...
 * Auswahl eines Menupunktes ausgef�hrt werden sollen. Ueber die Schnittstelle
...
public class Menu {
	...
	// Liste von m�glichen Commands im Menu
	...
	/**
	 * Neues Command der Liste von m�glichen Commands im Menu hinzufuegen
	 * 
	 * @param command - das Objekt des Commands, das ausgef�hrt werden soll bei Auswahl
	 */
	...
	public void showMenu() {
		...
		while(true) {
			...
			// ausgew�hltes Command ausf�hren
